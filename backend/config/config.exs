...
config :dimelo,
  ecto_repos: [Dimelo.Repo]

# Configures the endpoint
config :dimelo, DimeloWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: DimeloWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: Dimelo.PubSub,
  live_view: [signing_salt: "uCwMMNzJ"]
